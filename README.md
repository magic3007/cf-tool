...
> I replace all xalanq to izlyforever since I want to self contains. Sorry for that!!!
...
You can download the pre-compiled binary file in [here](https://github.com/izlyforever/cf-tool/releases).
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone izlyforever      Clone all codes of izlyforever.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/izlyforever/")
