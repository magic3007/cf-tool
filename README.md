...
[![Github release](https://img.shields.io/github/release/magic3007/cf-tool.svg)](https://github.com/magic3007/cf-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/magic3007/cf-tool/releases)
[![Build Status](https://travis-ci.org/magic3007/cf-tool.svg?branch=master)](https://travis-ci.org/magic3007/cf-tool)
[![Go Report Card](https://goreportcard.com/badge/github.com/magic3007/cf-tool)](https://goreportcard.com/report/github.com/magic3007/cf-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.12-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/magic3007/cf-tool/master/LICENSE)
...
> I replace all xalanq to magic3007 since I want to self contains. Sorry for that!!!
...
You can download the pre-compiled binary file in [here](https://github.com/magic3007/cf-tool/releases).
...
go get github.com/magic3007/cf-tool
cd ~/go/src/github.com/magic3007/cf-tool
go env -w CGO_ENABLED="0"
go build -ldflags "-s -w" cf.go
```

add `~/go/src/github.com/magic3007/cf-tool` in your path, and replace cf-tool by this repo, then
...
Examples:
  ...
  cf pull              Pull the latest codes of current problem into current
                       path.
  cf clone magic3007      Clone all codes of magic3007.
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/magic3007/")
 ...
 * You can download the binary file in here https://github.com/magic3007/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
